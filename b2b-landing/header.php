...
<body id="up">
   ...
   <header class="header sticky z-40 w-full sm:-ml-12 lg:ml-0">
      ...
      <div class="px-10 flex items-center justify-between mx-auto">
         <div class="p-5 md:p-10">
            <a class="block" href="index.php">
               <img class="w-11/12" src="./assets/images/logo.png" alt="">
            </a>
         </div>
         <div class="flex flex-col items-center justify-start">
            <button id="hamburger"
               class="block md:hidden relative z-10 select-none appearance-none border-none outline-none focus:outline-none cursor-pointer mb-3 group">
               <span
                  class=" block w-8 h-1 mb-1 relative rounded-md origin-top-left transition-all duration-300 bg-gray-700 z-99"></span>
               <span
                  class="block w-8 h-1 mb-1 relative rounded-md origin-top-left transition-all duration-300 bg-gray-700 z-99"></span>
               <span
                  class="block w-8 h-1 mb-1 relative rounded-md origin-top-left transition-all duration-300 bg-gray-700 z-99"></span>
            ...
            <nav class="nav hidden md:flex">
               <ul class="flex flex-col md:flex-row items-center justify-center">
                  <li class="relative mr-5 mb-3 md:mb-0 text-center">
                     <a class="block relative" href="hakkimizda.php">
                        Hakkımızda
                     </a>
                  </li>
                  <li class="relative mr-5 mb-3 md:mb-0 text-center">
                  ...
                  <li class="relative mr-5 mb-3 md:mb-0 text-center">
                     <a class="block relative" href="urunler.php">
                        Ürünler
                     </a>
                  </li>
                  <li class="relative mr-5 mb-3 md:mb-0 text-center">
                  ...
                  <li class="relative mr-5 mb-3 md:mb-0 text-center">
                     <a class="block relative" href="iletişim.php">
                        İletişim
                     </a>
                  </li>
